...
def preprocess_help(s: str):
    ...
    s = re.sub(r"default: /.*/power-plant", "default: <CACHE_DIR>", s)
    # Remove the commit SHA and target architecture triple
    s = re.sub(r"default: power-plant/.*-[0-9A-Fa-f]{6,10}/\w+-\w*-\w+", "default: power-plant/<VERSION>-<SHA>/<ARCH>", s)
    # Remove the OS
    s = re.sub(r"default: power-plant/.*/\w+", "default: power-plant/<VERSION>/<OS>", s)
