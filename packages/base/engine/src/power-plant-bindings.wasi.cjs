...
const __wasmDebugFilePath = __nodePath.join(
  __dirname,
  "power-plant-bindings.wasm32-wasi.debug.wasm"
);
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath =
      require.resolve("@power-plant/bindings-wasm32-wasi/power-plant-bindings.wasm32-wasi.wasm");
  } catch {
    throw new Error(
      "Cannot find power-plant-bindings.wasm32-wasi.wasm file, and @power-plant/bindings-wasm32-wasi package is not installed."
    );
  }
}
