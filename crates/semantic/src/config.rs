use crate::constants::{
    DEFAULT_EDGE_THRESHOLD, MAX_EDGES, THRESHOLD_MAX, THRESHOLD_MIN, W_API, W_DATAFLOW,
    W_DECORATOR, W_MINHASH, W_RI, W_STRUCT_PROFILE, W_TFIDF, W_TYPE,
};
...
impl SemanticConfig {
    /// Default config with optional `CBM_SEMANTIC_THRESHOLD` override.
    #[must_use]
    pub fn from_env() -> Self {
        let mut cfg = Self::default();
        if let Ok(thresh) = std::env::var("CBM_SEMANTIC_THRESHOLD") {
