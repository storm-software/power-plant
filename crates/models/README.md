...
# Power Plant - Models Crate

The **Power Plant - Models** crate provides data models used across the Power Plant ecosystem.
...
```bash
cargo add power-plant-models
```

## Building

Run `nx build native-models` to build the library.

## Running unit tests

Run `nx test native-models` to execute the unit tests via [Vitest](https://vitest.dev/).
