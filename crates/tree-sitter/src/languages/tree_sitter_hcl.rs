...
//!
//! Typically, you will use the [language][tree_sitter_hcl] function to add the HCL language to a
...
unsafe extern "C" {
    unsafe fn tree_sitter_hcl() -> Language;
}

/// Get the tree-sitter [Language][tree_sitter_hcl] for the HCL grammar.
///
/// [Language]: https://docs.rs/tree-sitter/*/tree_sitter/struct.Language.html
