...
The **Power Plant - Codebase Memory** crate provides bindings and wrapper logic to invoke the [codebase memory pipeline](https://github.com/DeusData/codebase-memory-mcp/tree/main/src/pipeline).
...
```bash
cargo add power-plant-cbm
```

## Building

Run `nx build native-cbm` to build the library.

## Running unit tests

Run `nx test native-cbm` to execute the unit tests via [Vitest](https://vitest.dev/).

## Acknowledgements

Huge thanks to [DeusData](https://github.com/DeusData) for their work on the codebase memory pipeline. Please check out their standalone MCP implementation at [codebase-memory-mcp](https://deusdata.github.io/codebase-memory-mcp) and star their [repository](https://github.com/DeusData/codebase-memory-mcp) on GitHub to show your support!
